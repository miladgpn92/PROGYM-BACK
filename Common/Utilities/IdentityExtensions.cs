...
namespace Common
{
    public static class IdentityExtensions
    {
        ...
        {
            return int.Parse(identity?.FindFirstValue(ClaimTypes.NameIdentifier));
        }

		public static int GetManagerLastSchoolId(this IIdentity identity)
		{
			return int.Parse(identity?.FindFirstValue("schoolid"));
		}
