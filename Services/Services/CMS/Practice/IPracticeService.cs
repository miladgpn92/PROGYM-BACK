...
namespace Services.Services.CMS.Practices
{
    public interface IPracticeService
    {
        ...
        Task<ResponseModel<PagedResult<PracticeSelectDto>>> GetListAsync(int gymId, int userId, string q, IEnumerable<int>? categoryIds, Pageres pager, CancellationToken cancellationToken);
